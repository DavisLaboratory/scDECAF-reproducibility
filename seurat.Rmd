...
ref <- CreateSeuratObject(counts = assay(seger)[, label_isnot_na])
...
predictions <- TransferData(anchorset = pancreas.anchors, refdata = seger$`cell type`[label_isnot_na], 
    dims = 1:30)
...
# save(baron_query, file = "baron_pancreas_seurat_preds.RData")
```
